...
const UUID = process.env.UUID || '34e302f1-8f5d-4f4d-816c-5cfeab181d9a'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'RqUKX4bU2YMih5XDqTbplxtC6mCDlbJL';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const NAME = process.env.NAME || 'sbhug';                       // 节点名称
